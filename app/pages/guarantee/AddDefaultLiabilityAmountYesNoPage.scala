...
case class AddDefaultLiabilityAmountYesNoPage(index: Index) extends QuestionPage[BigDecimal] {
  ...
  override def route(userAnswers: UserAnswers, mode: Mode): Option[Call] =
    Some(routes.AddDefaultLiabilityAmountController.onPageLoad(userAnswers.lrn, mode, index))
}
