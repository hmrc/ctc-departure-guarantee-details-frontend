...
import models.journeyDomain.{GuaranteeDomain, NavigationHelper}
import pages.QuestionPage

import javax.inject.{Inject, Singleton}

@Singleton
class GuaranteeNavigatorProviderImpl @Inject() (implicit config: FrontendAppConfig) extends GuaranteeNavigatorProvider {
...
class GuaranteeNavigator(
  ...
  implicit override val reader: Option[QuestionPage[_]] => UserAnswersReader[GuaranteeDomain] = {
    page =>
